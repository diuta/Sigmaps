...
| [api-community-sentiment.md](../context/api-community-sentiment.md) | `lib/sentiment/index.ts` — cache per stasiun di depan Gemini (didokumentasikan bersama endpoint-nya) |
